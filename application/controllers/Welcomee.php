...
class Welcomee extends CI_Controller
{
  ...
  public function autoLoadPage()
  {
    ...
    $data .= '<div class="col-sm-12 mt-4"><h5 style="font-size: 7vw;">Nama Tamu Undangan</h5></div>';
    $data .= '<div class="col-sm-12 mt-4"><h6 style="font-size: 3vw;">Asal Kota</h6>';
    $data .= '<h6 style="font-size: 1vw;">' . date('d/m/Y H:i:s') . '</h6>';
    $data .= '</div></div>';
    echo $data;
  }
}