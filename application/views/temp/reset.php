        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth lock-full-bg">
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
              <h3 class="card-title text-left mb-3">Reset Akun</h3>
              <form id="Formlogin" action="<?= base_url('resetakun/reset') ?>" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control p_input" name="serial" id="serial" required>
                </div>

                <div class="text-center">
                  <button type="submit" class="btn btn-primary btn-block enter-btn">Reset Akun</button>
                </div>
