              ...
              <div class="row mb-4">
                <div class="col-sm-6">
                  <div class="form-group">
                    <select style="width: unset;" name="page" id="page" class="form-control text-white d-inline">
                    ...
                    <?php if ($event['sesi'] > 1) : ?>
                    <select style="width: unset;" name="sesi" id="sesi" class="form-control text-white d-inline">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-12 text-center">
            ...
            <div class="form-group">
              <label for=""></label>
              <button type="button" onclick="copyTeks()" class="btn btn-primary">COPY</button>
            </div>
          </div>
        </div>
