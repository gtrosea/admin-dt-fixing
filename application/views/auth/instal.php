        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth lock-full-bg">
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
              <h3 class="card-title text-left mb-3">Instalasi Databse</h3>
              <form id="Formlogin" action="<?= base_url('loadd/creatDb') ?>" method="POST">
                <div class="form-group">
                  <label for="host">Database Host *</label>
                  <input type="text" class="form-control p_input" name="host" id="host" required
                    placeholder="ex: localhost">
                </div>
                <div class="form-group">
                  <label for="user">Database User *</label>
                  <input type="text" class="form-control p_input" name="user" id="user" required placeholder="ex: root">
                </div>

                <div class="form-group">
                  <label for="pass">Database Password </label>
                  <input type="text" class="form-control p_input" name="pass" id="pass" placeholder="ex: root">
                </div>

                <div class="form-group">
                  <label for="base">Database Name *</label>
                  <input type="text" class="form-control p_input" name="base" id="base" required
