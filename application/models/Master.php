  ...
  public function loadData()
  {
    ...
    if ($list) {
      ...
      foreach ($list as $key) {
        ...
        $data .= '<div class="alamat">' . $key['alamat'] . ' | ' . $key['keterangan'] . '</div>';
      ...
      data-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-settings"></i></button>';
        ...
        $data .= '<a class="dropdown-item btnEdit"  data-id="' . $key['id'] . '" data-nama="' . $key['nama'] . '" data-alamat="' . $key['alamat'] . '" data-keterangan="' . $key['keterangan'] . '" data-vip="' . $key['vip'] . '" href="#">Edit</a>';
        ...
        $data .= '<a class="btn btn-xs btn-info btnEdit" data-id="' . $key['id'] . '" data-nama="' . $key['nama'] . '" data-alamat="' . $key['alamat'] . '" data-keterangan="' . $key['keterangan'] . '" data-vip="' . $key['vip'] . '" href=""><i class="mdi mdi-pencil"> Edit</i></a>';
      ...
      echo '<h4 class="text-center text-danger">Tidak ada data ditemukan</h4>';
    }
  }
