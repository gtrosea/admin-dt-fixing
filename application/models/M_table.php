...
class M_table extends CI_Model
{
  ...
  public function addTabTamu()
  {
    ...
    return $this->dbforge->add_column('tamu', $field);
  }


  public function addTabTamuImport()
  {
    $field = [
      'keterangan' => [
        'type' => 'varchar',
    ...
    return $this->dbforge->add_column('tamu_import', $field);
  }

  public function addSesiTamuImport()
  {
    $this->load->dbforge();
    $field = [
      'sesi' => [
  ...
  public function creatTbSesi()
  {
    ...
    $this->dbforge->add_field($field);
    $this->dbforge->add_key('id', true);
    return $this->dbforge->create_table('event_sesi', true);
  }
